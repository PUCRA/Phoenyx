...
def generate_launch_description():
    ...
    world_file = './src/osr_gazebo/worlds/circuito_arucos_flotantes.world'
    ...
    spawn_entity = Node(
        ...
        arguments= ['-topic', 'robot_description', '-entity', 'rover','-x', '1.0', '-y', '2.0', '-z', '0.5'],
        output='screen',
        parameters=[{'use_sim_time': True}]  # use_sim_time agregado aquí también
    )
    ...
    # Add the controller manager node to ensure it's running
